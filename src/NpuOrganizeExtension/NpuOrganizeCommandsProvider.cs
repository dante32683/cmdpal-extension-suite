...
internal sealed partial class NpuOrganizeCommandsProvider : CommandProvider
{
    ...
    public NpuOrganizeCommandsProvider()
    {
        ...
        var index   = new ListItem(new IndexAllPage(_scanner, _indexService))                           { Title = "Index Screenshots",                 Subtitle = "Standardize screenshot names and reconcile the search index", Icon = OrganizeVisuals.Search  };
