...
internal static class Icons
{
    ...
    public static IconInfo PlayColorful { get; } = new IconInfo("\uE768");

    public static IconInfo PauseColorful { get; } = new IconInfo("\uE769");

    public static IconInfo SkipNextTrack { get; } = new IconInfo("\uE893");

    public static IconInfo SkipPreviousTrack { get; } = new IconInfo("\uE892");

    public static IconInfo SkipNextTrackDisabled { get; } = new IconInfo("\uE893");

    public static IconInfo SkipPreviousTrackDisabled { get; } = new IconInfo("\uE892");
    ...
    public static IconInfo Pause { get; } = new IconInfo("\uE769");
