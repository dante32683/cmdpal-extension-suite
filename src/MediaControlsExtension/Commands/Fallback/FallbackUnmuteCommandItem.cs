...
internal sealed partial class FallbackUnmuteCommandItem : FallbackCommandItem
{
    ...
    public FallbackUnmuteCommandItem(SettingsManager settingsManager, YetAnotherHelper yetAnotherHelper) : base(new NoOpCommand(), Strings.Command_Unmute, "com.dziad.mediacontrolsextension.unmute")
    {
