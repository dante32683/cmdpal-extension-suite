...
internal sealed partial class FallbackPlayCommandItem : FallbackCommandItem
{
    ...
    public FallbackPlayCommandItem(ICommand command, string displayTitle, SettingsManager settingsManager) : base(command, displayTitle, "com.dziad.mediacontrolsextension.play")
    {
